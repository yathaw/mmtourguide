	            ...
	            <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            Updat Exisiting <strong> Country </strong>
                        </div>
                        ...
                        <form action="{{route('admin.country.update', $country->id)}}" method="post" class="form-horizontal" enctype="multipart/form-data">
	                        ...
	                        <div class="card-body card-block">
	                        	<div class="row form-group">
                                    ...
                                    <div class="tab-content pl-3 pt-2" id="nav-tabContent">
                                        <div class="tab-pane fade show active" id="custom-nav-home" role="tabpanel" aria-labelledby="custom-nav-home-tab">
                                            <img src="{{ $country->passportcover }}" class="img-fluid" style="width: 100px; height: 90px;">
											<input type="hidden" name="oldphoto" value="{{ $country->passportcover }}">
	                            ...
	                            <div class="row form-group">
	                                ...
	                                <div class="col-12 col-md-10">
	                                	<input type="text" id="name" name="name" countryholder="Enter Name..." class="form-control" value="{{ $country->name }}">
