	...
	<div class="breadcrumbs">
	    ...
	    <div class="col-sm-8">
	        <div class="page-header float-right">
	            <div class="page-title">
	                <a href="{{ route('admin.language.index') }}" class="btn btn-primary mt-1"> 
	        ...
	        <div class="row">
	            ...
	            <div class="col-lg-12">
                    <div class="card">
                        ...
                        <form action="{{route('admin.language.update', $language->id)}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                          	@csrf
                          	@method('PUT')
	                        ...
	                        <div class="card-body card-block">
	                        	<div class="row form-group">
                                    ...
                                    <div class="tab-content pl-3 pt-2" id="nav-tabContent">
                                        <div class="tab-pane fade show active" id="custom-nav-home" role="tabpanel" aria-labelledby="custom-nav-home-tab">
                                            <img src="{{ $language->flag }}" class="img-fluid" style="width: 100px; height: 90px;">
											<input type="hidden" name="oldphoto" value="{{ $language->flag }}">
	                            ...
	                            <div class="row form-group">
	                                ...
	                                <div class="col-12 col-md-10">
	                                	<input type="text" id="name" name="name" languageholder="Enter Name..." class="form-control" value="{{ $language->name }}">
