	                        ...
	                        <table class="bootstrap-data-table-export table table-striped table-bordered">
	                            ...
	                            <tbody>
	                            	...
	                            	@foreach($bookingdetails as $bookingdetail)
										...
										<tr>
											<td> {{ $i }} </td>
											<td> {{ $bookingdetail->booking->tokenno }} </td>
											<td> {{ $bookingdetail->status }} </td>
											<td>

												<a href="{{ URL::to('tourguide/bookingconfirm/'.$bookingdetail->id) }}" class="btn btn-outline-success"> 
													<i class="fa fa-mail-reply"></i>	Confirm 
												</a>

												<a href="{{ URL::to('tourguide/bookingdetail/'.$bookingdetail->id) }}" class="btn btn-primary"> 
