...
<body>
	<div class="container">
		...
		<div class="row">
			...
			<p> Now You are our tourist member! </p>
			
			<a href="http://localhost:8000/confirmlogin/{{ $data['toruistid'] }}" class="btn btn-success btn-block" style="background-color: #4CAF50; /* Green */
  border: none;
  color: white;
  padding: 15px 32px;
  text-align: center;
